...
public class SnakeHead : BodyPart
{
    ...
    override public void Update() // In BodyPart class this function must be virtual
    {
    ...
    void AddBodyPart()
    {
        ...
        else
        {
            ...
            BodyPart newPart = Instantiate(GameController.instance.bodyPrefab, newPosition, tail.transform.rotation);  // setting the orientation of the newly generated tail in motion direction
    ...
    public void ResetSnake()
    {
        ...
        // reset the position of head
        gameObject.transform.localEulerAngles = new Vector3(0, 0, 0); // reseting orientation of head image
        gameObject.transform.position = new Vector3(0, 0, -7.93f); // reseting position of head
    ...
    private void OnTriggerEnter2D(Collider2D collision)
    {
        ...
        if (egg)
        {
            ...
            // playing random gulp sound from 3 different sources stored in array
